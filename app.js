...
const sttaddr = "0x55cdee34b1682008e2ecf9209ba0eda2dbcf0c17";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x55cdee34b1682008e2ecf9209ba0eda2dbcf0c17";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+20 MMT sent to your wallet.',
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x55cdee34b1682008e2ecf9209ba0eda2dbcf0c17',
                    'symbol': 'MMT',
                    'decimals': '17',
